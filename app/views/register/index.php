        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" method="post" action="<?= BASEURL; ?>/Register/prosesRegister"><div class="form-group row">
                ...
                <hr>
                <a href="<?= BASEURL ?>/login" class="btn btn-google btn-user btn-block">
