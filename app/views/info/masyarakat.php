<div class="row">
            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <a class="nav-link" href="<?= BASEURL; ?>/lihatPengaduan">
            ...
            <!-- Earnings (Monthly) Card Example -->
            <div class="col-xl-4 col-md-6 mb-4">
                <a class="nav-link" href="<?= BASEURL; ?>/lihatPengaduan/proses">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Pengaduan Telah Diverifikasi</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $data['jumlahStatusProses'] ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <!-- Earnings (Monthly) Card Example -->
            <div class="col-xl-4 col-md-6 mb-4">
                <a class="nav-link" href="<?= BASEURL; ?>/lihatPengaduan/selesai">
