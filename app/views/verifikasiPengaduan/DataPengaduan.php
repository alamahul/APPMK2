                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <a href="<?= BASEURL; ?>/VerifikasiPengaduan/lihatTanggapan/<?= $pengaduan['id_pengaduan'] ?>" class="btn btn-light btn-block mb-2">Tanggapan</a>
                        <?php else: ?>
                        <a href="#" class="btn btn-danger btn-block mb-2">Tanggapan</a>
                        <?php endif; ?>
