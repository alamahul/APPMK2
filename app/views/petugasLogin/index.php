        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" method="post" action="<?= BASEURL; ?>/petugasLogin/proseslogin">
                ...
                <hr>
                <a href="<?= BASEURL ?>/petugasRegister" class="btn btn-google btn-user btn-block">
                  <i class="fas fa-registered fa-1x float-left"></i> Belum punya Akun Silahkan Register
                </a>
                <a href="<?= BASEURL; ?>/Login" class="btn btn-facebook btn-user btn-block">
