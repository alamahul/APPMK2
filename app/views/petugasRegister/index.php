        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-5">
              ...
              <form class="user" method="post" action="<?= BASEURL; ?>/PetugasRegister/prosesRegister"><div class="form-group row">
                ...
                <hr>
                <a href="<?= BASEURL ?>/PetugasLogin" class="btn btn-google btn-user btn-block">
